...
<body class="landing">
    ...
    <section id="banner">
        ...
        <p>Quick Search <br> Online Bookings <br> Pay Online <br> Hassle Free Bus Booking<br>Brought To You By
            code-projects.org</p>
        <ul class="actions">
            <li>
        ...
        <div class="container">
            ...
            <div class="row 200%">
                <section class="4u 12u$(small)">
                    ...
                    <p>You can book the tickets before one month<br> You can cancel the tickets one day before the
                        journey with 100% refund</p>
                </section>
                <section class="4u 12u$(small)">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <p><b> Why BookMyBusTicket for Bus Booking? </b>
                    <br>The leading player in online Bus bookings in the country, We offer lowest fares, exclusive
                    discounts and a seamless online booking experience. Desktop or mobile site is a delightfully
                ...
                <p><b>Booking Bus Ticket with BookMyBusTicket</b> <br>
                    With more than 1000 bus routes spread across the country and integration with over 1300 bus
                    operators, MakeMyTrip's online bus reservation system is simpler and smarter. It provides you a wide
                    range of facilities, right from choosing your pickup point to your preferred choice of seat (for
                    instance, luxury buses with sleeper berths). You can also choose from the widest range of available
                    buses like Mercedes, Volvo, Volvo AC, AC luxury, Deluxe, Sleeper, Express and other private buses.
                    The payment options are easier too- you can use either debit/credit card facility or net-banking.
                    Not just that, in case of any change in your travel plan, bus tickets can be cancelled online. So,
                    next time you need not stand in long queues or search at different bus ticket counters. You can
                    directly book bus tickets online with BookMyBusTicket.com and stay assured.</p>
            </div>
            <footer>
                <ul class="actions">
                    <li>
                ...
                <p> <b> SAVE BIG ONE BUS TICKETS!! GET UPTO RS.300 INSTANT DISCOUNT. <BR> COUPON CODE : DISBOOKBUS </b>
                </p>
            </footer>
        </div>
    </section>
    ...
    <footer id="footer">
        <div class="container">
            ...
            <ul class="copyright">
                <li>&copy; 2017 BookMyBusTicket. All rights reserved. Brought To You By <a
                        href="https://code-projects.org/">Code-Projects</a></li>
