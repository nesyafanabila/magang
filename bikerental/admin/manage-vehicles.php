            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h2 class="page-title">Data Motor</h2>
                            ...
                            <div class="panel-body">
                                ...
                                <table id="zctb" class="display table table-striped table-bordered table-hover"
                                    ...
                                    <tbody>
                                        ...
                                        <?php $sql = "SELECT tblvehicles.VehiclesTitle,tblbrands.Nama,tblvehicles.PricePerDay,tblvehicles.FuelType,tblvehicles.bahanbakar,tblvehicles.id from tblvehicles join tblbrands on tblbrands.id=tblvehicles.VehiclesBrand";
$query = $dbh -> prepare($sql);
$query->execute();
...
{				?>
                                        <tr>
                                            ...
                                            <td>Rp <?php echo number_format($result->PricePerDay, 0, ',', '.');?></td>
