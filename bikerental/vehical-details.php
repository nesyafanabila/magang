        ...
        <div class="listing_more_info">
          <div class="listing_detail_wrap">
            ...
            <ul class="nav nav-tabs gray-bg" role="tablist">
              <li role="presentation" class="active"><a href="#vehicle-overview " aria-controls="vehicle-overview" role="tab" data-toggle="tab">Ringkasan </a></li>
...
<tr>
<td>Sistem Pengereman Anti Lock (ABS) </td>
...
<?php }} ?>
      ...
      <aside class="col-md-3">
          ...
          <div class="widget_heading">
            <h5><i class="fa fa-envelope" aria-hidden="true"></i>SEWA</h5>
          </div>
          <form method="post">
          ...
          <?php if($_SESSION['login'])
              {?>
              <div class="form-group">
                <input type="submit" class="btn"  name="submit" value="SEWA">
              </div>
              <?php } else { ?>
...
?>
             ...
             <li><i class="fa fa-tint" aria-hidden="true"></i> Bensin <?php echo htmlentities($result->bahanbakar);?></li>
