...
{				?>
                                        <tr>
                                            ...
                                            <td><a href="manage-bookings.php?id=<?php echo htmlentities($result->id);?>"
                                                    onclick="return confirm('Do you really want to Confirm this booking')">
                                                    Confirm</a> /


                                                <a href="manage-bookings.php?id=<?php echo htmlentities($result->id);?>"
