                ...
                <div class="col-sm-9 col-md-10">
                    <div class="header_info">
                        <div class="header_widgets">
                            ...
                            <a href="mailto:info@example.com">nesyanabila156@gmail.com</a>
                        </div>
                        <div class="header_widgets">
                            <div class="circle_icon"> <i class="fa fa-phone" aria-hidden="true"></i> </div>
                            <p class="uppercase_text">Service Helpline Call Us: </p>
                            <a href="tel:+639079373999">+6289526824568</a>
                        </div>
                        ...
                        <?php } else {
                            ...
                            echo "Selamat Datang di Online Bike Rental ";
                        } ?>
                    </div>
                </div>
            </div>
                    ...
                    <ul>
                        <li class="dropdown"> <a href="#" data-toggle="dropdown" aria-haspopup="true"
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="update-password.php">Edit Password</a></li>
                                <li><a href="my-booking.php">Booking</a></li>
                                <li><a href="post-testimonial.php">Edit Testimonial</a></li>
